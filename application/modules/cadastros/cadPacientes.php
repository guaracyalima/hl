	...
	<form action="" method="post" accept-charset="utf-8" class="form-inline" novalidate=""  class="my-form" name="formCadastro">	
		...
		<div class="panel panel-success">
			...
			<div class="row">
					...
					<div class="form-group">
						<label for="numendpaciente">Número:</label>
						<input class="form-control" type="numendpaciente" id="numendpaciente">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="form-group">
						...
						<input class="form-control" type="bairropaciente" id="bairropaciente" />
					</div>

					<div class="form-group">
						<label for="cidadepaciente">Cidade:</label>
						<input class="form-control" type="cidadepaciente" id="cidadepaciente" />
					</div>
				...
				<div class="row">
					...
					<div class="form-group">
						...
						<select name="estcivilpaciente" id="estcivilpaciente" class="form-control">
				...
				<div class="row">	
					<div class="form-group">
						<label for="insttratamento">Instruções para tratamentos:</label>
						<textarea id="insttratamento" class="form-control" rows="4"></textarea>
					</div>
				</div>
			</div>
		</div>
