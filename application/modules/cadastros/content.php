...
<div class="container-fluid">
	<legend class="titulo-padrao">Cadastro de Pacientes</legend>
	...
	<form action="" method="post" accept-charset="utf-8" class="form-inline" novalidate=""  class="my-form" name="formCadastro">	
		...
		<div class="panel panel-success"> <!-- inicio do painel de dados primarios do paciente -->
			<div class="panel-heading text-center">
				<h4 class="titulo-padrao">Triagem</h4>
			</div>
		...
		<div class="panel panel-success">
			<div class="panel-heading">
				<h4 class="titulo-padrao">Dados pessoais</h4>
			</div>
			<div class="panel-body">
				...
				<div class="row">
					...
					<div class="form-group">
						...
						<input class="form-control" type="nomepaciente" class="form-control" id="nomepaciente" ng-model="userType" required autofocus="" />
		...
		<div class="panel panel-success">
			<div class="panel-heading"><h4 class="titulo-padrao">Informações adicionais</h4></div>
			<div class="panel-body">
