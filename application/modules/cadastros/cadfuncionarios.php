			...
			<form action="" method="post" accept-charset="utf-8" class="form-inline" novalidate=""  class="my-form" name="formCadastro">	
				...
				<div class="panel panel-success">
					...
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="form-group">
								<label for="rgprofissional">Número:</label>
						...
						<div class="row">
							...
							<div class="form-group">
								<label for="dtnascprofissional">Cidade:</label>
								<input class="form-control" type="dtnascprofissional" id="dtnascprofissional" />
							</div>
						...
						<div class="row">
							...
							<div class="form-group">
								<label for="planSaude">Código Conselho</label>
								<div class="form-group">
					...
					<br>
						<div class="row">
							...
							<div class="form-group">
								<label for="sexoprofissional">Função:</label>
								<select name="EstadoCivil" id="EstadoCivil" class="form-control">
						...
						<div class="row">
							...
							<div class="col-sm-4">
								<label for="especialidade1">Especialidade 2:</label>
								<input type="especialidade1" id="especialidade1" class="form-control"/>        
							</div>	

							<div class="col-sm-4">
								<label for="especialidade1">Especialidade 3:</label>
								<input type="especialidade1" id="especialidade1" class="form-control" />        
							</div>
				...
				<div class="tab-content">
					<div id="home" class="tab-pane fade in active">
						...
						<div class="form-group">
							<label for="planSaude">Documento</label>
					...
					<div id="menu2" class="tab-pane fade">
						...
						<textarea id="msg" class="form-control" rows="3" maxlength="1000" minlength="10"></textarea>
